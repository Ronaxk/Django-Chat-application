...
SECRET_KEY = 'django-insecure-zu#_z-%4=mdxhwfm=!u#!f((#gi&98_djp1=+3b+1&(g1)wtv)'
...
# Specify the channel layer as Redis
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels_redis.core.RedisChannelLayer",
        "CONFIG": {
            # Configure the Redis server (if running on localhost)
